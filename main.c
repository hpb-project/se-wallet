...
//				printf("Identify succ, tid=%d, score=%d\n", tid, score);
				if(tid==1)
                {
				    printf("识别成功，手指及其对应的数字分别为: 左大拇指, 0 \n");
                }
                if(tid==2)
                {
                    printf("识别成功，手指及其对应的数字分别为: 左食指, 1 \n");
                }
                if(tid==3)
                {
                    printf("识别成功，手指及其对应的数字分别为: 左中指, 2 \n");
                }
                if(tid==4)
                {
                    printf("识别成功，手指及其对应的数字分别为: 左无名指, 3 \n");
                }
                if(tid==5)
                {
                    printf("识别成功，手指及其对应的数字分别为: 左小拇指, 4 \n");
                }
                if(tid==6)
                {
                    printf("识别成功，手指及其对应的数字分别为: 右大拇指, 5 \n");
                }
                if(tid==7)
                {
                    printf("识别成功，手指及其对应的数字分别为: 右食指, 6 \n");
                }
                if(tid==8)
                {
                    printf("识别成功，手指及其对应的数字分别为: 右中指, 7 \n");
                }
                if(tid==9)
                {
                    printf("识别成功，手指及其对应的数字分别为: 右无名指, 8 \n");
                }
                if(tid==10)
                {
                    printf("识别成功，手指及其对应的数字分别为: 右小拇指, 9 \n");
                }
			}
		}
		else
...
//    }
	...
	while(1)
	{
        ...
        {
            m_bRegister = 1;
            printf("Doing resiger, Please place finger 2 times\n");
        }
